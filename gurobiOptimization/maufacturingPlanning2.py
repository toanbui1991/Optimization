# -*- coding: utf-8 -*-
"""
Created on Tue May 23 23:59:36 2017
...
model.Params.UpdateMode = 1 #what is the purpose of this code?
...
#machine down is a decision variable.
...
#Balance
#note: you have already know how to add constraints using if for condition.
#note: in this case the inventory balance except the first period.
...
#Capacity
#note: d[time_period, machine] is machine down decision variables
...
#Maintenance
#note: qMaintenance[machine] is the number of 'machine' need to maintain.
