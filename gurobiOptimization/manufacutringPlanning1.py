# -*- coding: utf-8 -*-
"""
Created on Tue May 23 23:40:58 2017
...
model = Model('Factory Planning I') #create the model object

#you have already know how to create a decision varaibles with indeces.
...
# Initial Balance
#note: for each product you create the initial balance constraints 
...
#Balance
#note: for each product and each period (except the initial period) you create a balance constraint
#note: if time_period != time_period[0] is conditioning with the meaning of except.
...
# Capacity
#note: how know how to use quicksum().
#note: you know how to use if to condition.
#note: if with in and not in.
...
# Objective
#note: in this case you write the objective function before and then
#change to objective attribute of the object model.
obj = quicksum(
