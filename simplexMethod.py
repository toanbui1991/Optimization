# -*- coding: utf-8 -*-
"""
Created on Sun Dec 25 20:57:44 2016
...
class Tableau:
    ...
    def __init__(self, obj):
        ...
        #obj: objective function is a list of coeffiecient.
        #other attribute to build the table later.
        self.obj = [1] + obj
        self.rows = []
        self.cons = []
 
    def add_constraint(self, expression, value):
        #epxression is a list of coefficeint for the constraint matrix
        #value is the right hand side value of the constraint.
        self.rows.append([0] + expression)
        self.cons.append(value)
 
    def _pivot_column(self):
        #get the pivot column, the smallest negative element of the objective
        #function.
        low = 0
        idx = 0
    ...
    def _pivot_row(self, col):
        #get the pivot row, the smalles ratio between rhs and the current
        #non basic variable coefficient given you know pivot column
    ...
    def display(self):
        #display the table with matrix form, or array form
        print('\n', matrix([self.obj] + self. rows))
 
    def _pivot(self, row, col):
        #this function will do the pivot operation.
        #or row operation in math.
        e = self.rows[row][col]
        self.rows[row] /= e
    ...
    def _check(self):
        #return true if the table is optimiation
        #false otherwise
